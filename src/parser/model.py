...
def add_model_options(parser):
    ...
    group.add_argument("--modelname", default='cvae_transformer_rc_rcxyz_kl', help="Choice of the model, should be like cvae_transformer_rc_rcxyz_kl")
    group.add_argument("--latent_dim", default=256, type=int, help="dimensionality of the latent space")
    group.add_argument("--lambda_kl", default=1e-5, type=float, help="weight of the kl divergence loss")
